...
//     setLocalSlide({ ...slide });
//     // اگر backgroundImage یک URL است (نه data URL)، آن را در imageUrl هم قرار بده
//     if (slide.backgroundImage && !slide.backgroundImage.startsWith('data:')) {
//       setImageUrl(slide.backgroundImage);
//       setPreview(slide.backgroundImage);
//     }
//   }, [slide]);
...
//     // استفاده از window.Image برای جلوگیری از conflict
...
//         ...localSlide,
//         backgroundImage: "",
//         backgroundColor: localSlide.backgroundColor || "#ffffff",
//       });
//       setLoading(false);
//     };
...
//     if (originalSlide.backgroundImage && !originalSlide.backgroundImage.startsWith('data:')) {
//       setImageUrl(originalSlide.backgroundImage);
//       setPreview(originalSlide.backgroundImage);
//     } else {
//       setImageUrl("");
//       setPreview(null);
//     }
...
//       };
//     } else if (localSlide.backgroundColor) {
//       return {
//         backgroundColor: localSlide.backgroundColor,
//       };
//     } else if (localSlide.backgroundImage && !preview) {
//       // اگر URL ذخیره شده اما preview نداریم، باز هم سعی می‌کنیم نمایش دهیم
//       return {
//         backgroundImage: `url(${localSlide.backgroundImage})`,
//         backgroundSize: 'cover',
//         backgroundPosition: 'center',
//       };
//     }
...
//                 <p>Enter a direct link to an image starting with http:// or https://</p>
//               </div>
//             </div>
//           </div>
...
//                 style={getBackgroundStyle()}
//               >
//                 {!preview && !localSlide.backgroundColor && !localSlide.backgroundImage && (
//                   <div className="text-gray-400 text-sm">
//                     No background selected
//                   </div>
//                 )}
//                 {!preview && localSlide.backgroundColor && (
...
//               {(localSlide.backgroundImage || localSlide.backgroundColor) && (
